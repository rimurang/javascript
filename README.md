...
<a href="https://school.programmers.co.kr/learn/courses/30/lessons/120829" target="_blank" title="문자열  섞기">https://school.programmers.co.kr/learn/courses/30/lessons/120829</a>
...
const solution = (angle) => {
    return angle == 90 ? 2 : angle == 180 ? 4 : angle > 90 ? 3 : 1
}
```
